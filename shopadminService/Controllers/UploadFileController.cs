...
namespace shopadminService.Controllers
{
    ...
    public class UploadFileController : ControllerBase
    {
        ...
        private readonly IUploadConfig _fileUploadConfig;
         private readonly IUpLoadFileService _uploadfileservice;
        public UploadFileController(ILogger<UploadFileController> logger, IUpLoadFileService uploadfileservice, IUploadConfig fileUploadConfig)
        {
            _logger = logger;
        ...
        public async Task<ResultObject> uploadImage([FromForm] int appType, [FromForm] int businessId, IFormFile file)
        {
            try
            {
                string url = _fileUploadConfig.UploadUrl;
                string root= _fileUploadConfig.UploadPath;
